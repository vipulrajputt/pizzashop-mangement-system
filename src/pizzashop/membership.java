...
public class membership extends javax.swing.JFrame {
    ...
    Connection con;
    Statement st;
    public membership() throws ClassNotFoundException {
        initComponents();
          try {
    ...
    private void initComponents() {
        ...
        submit.setBounds(290, 750, 280, 80);
        ...
        contact.setBounds(400, 670, 400, 50);
        ...
        loginbg.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pizzashop/img/loginbg1.png"))); // NOI18N
...
String number=contact.getText();
        ...
        try {
            int i= st.executeUpdate("insert into member values('"+name+"','"+addr+"','"+em+"','"+number+"')");
            if(i>0)
                JOptionPane.showMessageDialog(null, "\tCONGRATULATIONS\nYOU ARE ONE OF OUR MEMBER NOW.", "SUCCESS", JOptionPane.INFORMATION_MESSAGE);
        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(null, "THE CONTACT NO IS ALREADY REGISTERED\n\t\tOR \nYOU HAVE NOT ENTERD THE CONTACT NO.", "ERROR", JOptionPane.ERROR_MESSAGE);
            Logger.getLogger(membership.class.getName()).log(Level.SEVERE, null, ex);
